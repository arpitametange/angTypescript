...
console.log("Price: ".concat(hundyai.Price()));
console.log("Total seat: ".concat(hundyai.getTotalSeats()));
console.log("Color: ".concat(hundyai.Color()));
var hundyaiClass = /** @class */ (function () {
    function hundyaiClass() {
    }
    hundyaiClass.prototype.gps = function () {
        return "Supported";
    };
    return hundyaiClass;
}());
var hundyai = new hundyaiClass();
console.log("GPS: ".concat(hundyai.gps()));
...
console.log("Price: ".concat(tata.Price()));
console.log("Total seat: ".concat(tata.getTotalSeats()));
console.log("Color: ".concat(tata.Color()));
